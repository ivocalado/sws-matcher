...
public class Dijkstra<T> {
	 ...
	 * @param nos
	 */
	public Dijkstra(final Vertex<T>[] nos) {
		this.setNos(nos);
	}
	 ...
	 * @param nos
	 */
	public void setNos(final Vertex<T>[] nos) {
		this.nos = nos;
	}
	...
	public boolean emN(final Vertex<T> no) {
	...
	public Vertex<T>[] doDijkstra(final Vertex<T> origem,
			final Vertex<T> destino) {
		int i = 0, j = 0;
		Vertex<T> menor = null, atual = null; // �ltimo n� adicionado a N
